...
class Ui_themeEditor(object):
    def setupUi(self, themeEditor):
        ...
        self.label_lineNumbersSize = QLabel(self.fontSize_groupBox)
        self.label_lineNumbersSize.setObjectName("label_lineNumbersSize")
        self.lineNumbersSize_spb = QSpinBox(self.fontSize_groupBox)
        self.lineNumbersSize_spb.setMinimum(6)
        self.lineNumbersSize_spb.setMaximum(25)
        self.lineNumbersSize_spb.setProperty("value", 10)
        self.lineNumbersSize_spb.setObjectName("lineNumbersSize_spb")
        self.fontSize_layout.addWidget(self.label_lineNumbersSize, 0, 2)
        self.fontSize_layout.addWidget(self.lineNumbersSize_spb, 0, 3)
        ...
        self.fontSize_layout.addWidget(self.label_menuSize, 1, 0)
        self.fontSize_layout.addWidget(self.menuSize_spb, 1, 1)
        ...
        self.fontSize_layout.addWidget(self.label_outlineSize, 1, 2)
        self.fontSize_layout.addWidget(self.outlineSize_spb, 1, 3)
        ...
        self.fontSize_layout.addWidget(self.label_outputSize, 2, 0)
        self.fontSize_layout.addWidget(self.outputSize_spb, 2, 1)
        ...
        self.fontSize_layout.addWidget(self.label_statusBarSize, 2, 2)
        self.fontSize_layout.addWidget(self.statusBarSize_spb, 2, 3)
        ...
        self.fontSize_layout.addWidget(self.label_tabSize, 3, 2)
        self.fontSize_layout.addWidget(self.tabSize_spb, 3, 3)
    ...
    def retranslateUi(self, themeEditor):
        ...
        self.label_lineNumbersSize.setText(QApplication.translate("themeEditor", "Line numbers", None))
        self.lineNumbersSize_spb.setToolTip(QApplication.translate("themeEditor", "Set the font size for the line numbers", None))
