...
class Ui_scriptEditor(object):
    def setupUi(self, scriptEditor):
        ...
        self.ontop_act = QAction(scriptEditor)
        self.ontop_act.setObjectName("ontop_act")
        self.ontop_act.setCheckable(True)
        ...
        self.options_menu.addAction(self.ontop_act)
    ...
    def retranslateUi(self, scriptEditor):
        ...
        self.ontop_act.setText(QApplication.translate("scriptEditor", "Always on top", None))
